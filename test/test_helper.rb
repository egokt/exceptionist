...
# We use metaprogramming to create the class that executes exceptionist,
# because there are many test cases.
# See the test_plan.txt for details.
require 'test_case_factory'
